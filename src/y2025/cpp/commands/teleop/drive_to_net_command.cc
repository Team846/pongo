...
DriveToNetCommand::DriveToNetCommand(RobotContainer& container,
    bool is_retracting, units::feet_per_second_t max_speed,
...
std::pair<frc846::math::FieldPoint, bool> DriveToNetCommand::GetTargetPoint() {
  ...
  if (is_retracting_) { net_offest = 50_in; }
