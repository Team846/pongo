...
TelescopeSubsystem::TelescopeSubsystem()
    : IclinSubsystem("telescope",
          ...
          frc846::control::config::MotorConstructionParameters{
              ...
              .rotational_inertia = frc846::wpilib::unit_kg_m_sq{2.43947e-05}},
...
IclinTarget TelescopeSubsystem::ZeroTarget() const { return IclinTarget{0_in}; }
