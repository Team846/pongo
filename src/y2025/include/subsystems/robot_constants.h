...
struct robot_constants {
  struct base {
    ...
    static constexpr units::pound_t weight = 38_lb;
  ...
  struct elevator {
    ...
    static constexpr units::pound_t end_effector_weight = 44_lb;
  ...
  struct telescope {
    ...
    static constexpr units::pound_t end_effector_weight = 26_lb;
    static constexpr units::pound_t total_weight =
